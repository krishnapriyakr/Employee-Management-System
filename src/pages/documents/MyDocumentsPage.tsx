...
import { getMyDocuments, downloadDocument,type Document, formatFileSize, getCategoryIcon, getCategoryLabel } from '../../api/documentsApi';
    ...
    <Layout>
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 border-l-4 border-primary-500">
          ...
          <p className="text-gray-600 mt-1">View and download your personal documents</p>
        </div>
        ...
        {documents.length === 0 ? (
          <div className="bg-white rounded-xl shadow-sm p-12 text-center">
            ...
            <p className="text-sm text-gray-400 mt-1">Documents uploaded by HR will appear here</p>
          </div>
        ) : (
            ...
            {documents.map((doc) => (
              <div key={doc._id} className="bg-white rounded-xl shadow-sm hover:shadow-md transition p-6 border border-gray-200">
                ...
                <button
                  ...
                  className="w-full bg-primary-500 hover:bg-primary-600 text-white py-2 rounded-lg text-sm font-medium transition-colors"
                >
                  Download Document
                </button>
              </div>
